...
tofutimeseries<-ts(data$tofu, frequency=52, start=c(2004,1,4))
#plot(decompose(tofutimeseries))
tofuforecast<-HoltWinters(tofutimeseries)
#plot(tofuforecast)
tofufuture <- forecast.HoltWinters(tofuforecast, h=48)
plot.forecast(tofufuture)
